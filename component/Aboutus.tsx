          ...
          <div className="row">
            <div className="col-sm-12 col-md-7 col-lg-6 content-center">
              ...
              <ul className='p-0 font-family-primary' >
                ...
                <li className='font-16 d-flex align-items-center gap-16px'>
                  <Image src={ticker} alt='' />
                  <p className='font-weight-500 text-dark-gray'>With our innovative digital solutions, you can stay ahead of the curve and remain competitive in today's fast-paced digital landscape.</p>
                </li>
              </ul>
