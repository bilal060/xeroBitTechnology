...
const Websolutions = () => {
    return (
        <>
            <section className='web-solutions img-right-contianer-out pt-5 pb-3 mt-2'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-6 col-lg-6'>
                            <h6 className='font-weight-500 font-18-17 text-xero-primary text_center_justification pt-2'>You Think, We Code</h6>
                            <h2 className='font-weight-700 font-36-46 mt-2 text_center_justification pt-2'>Productive & engaging web solutions for your business</h2>
                        ...
                        <div className='col-md-6 col-lg-6 g-0 image_right_container disply_none'>
