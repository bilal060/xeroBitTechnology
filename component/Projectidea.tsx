    ...
    return (
        <>
            <section className="project-plan ">
                <Image src={leftimage} alt="left-image" className='animate-img img-fluid left-image' />
                ...
                <Image src={rightimage} alt="right-image" className='animate-img-delay img-fluid right-image' />
            </section>
        </>
    )
}
